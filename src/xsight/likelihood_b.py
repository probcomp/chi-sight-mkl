# AUTOGENERATED! DO NOT EDIT! File to edit: ../../notebooks/11b - Constrained Likelihood V2.ipynb.

# %% auto 0
__all__ = ['key', 'tfd', 'uniform', 'truncnormal', 'normal', 'diagnormal', 'mixture_of_diagnormals', 'mixture_of_normals',
           'mixture_of_truncnormals', 'normal_logpdf', 'normal_pdf', 'truncnorm_logpdf', 'truncnorm_pdf', 'min', 'max',
           'threedp3_outlier', 'get_projections_and_distances', 'get_1d_mixture_components', 'dslice', 'pad', 'mix_std',
           'clip_depth', 'get_1d_mixture_components_b', 'make_constrained_sensor_model', 'get_data_logprobs',
           'get_gaussian_blurr_weights', 'make_blurred_sensor_model', 'make_blurred_sensor_model_2', 'ThreeDP3Outlier',
           'make_baseline_sensor_model']

# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 3
import jax
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 5
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 7
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 11
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 12
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 27
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 28
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 29
def get_projections_and_distances(x, ys):
    """Returns projections and distances of y's on and to ray through x."""
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 30
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 32
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 35
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 37
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 45
# TODO: The input Y should be an array only containing range measruements as well. 
#       For this to work we need to have the pixel vectors (the rays through each pixel)
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 46
# TODO: The input Y should be an array only containing range measruements as well. 
#       For this to work we need to have the pixel vectors (the rays through each pixel)
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 50
...
# %% ../../notebooks/11b - Constrained Likelihood V2.ipynb 51
